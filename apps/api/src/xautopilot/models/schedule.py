...
class Schedule(Base):
    ...
    tweets_per_day: Mapped[int] = mapped_column(Integer, nullable=False, default=3)
    threads_per_week: Mapped[int] = mapped_column(Integer, nullable=False, default=2)
    replies_per_day: Mapped[int] = mapped_column(Integer, nullable=False, default=15)
